package net.tirzaanneil.tutorialmoding.item;
...
import net.tirzaanneil.tutorialmoding.TutorialMod;
...
public class ModItemGroups {
    ...
    public static final ItemGroup PINK_GARNET_BLOCK_GROUP = Registry.register(Registries.ITEM_GROUP,
            Identifier.of(TutorialMod.MOD_ID, "pink_garnet_blocks"), FabricItemGroup.builder()
